...
=======
>>>>>>> 7fb131b8acf525f838ff16a0595130fc36f2bcf2
...
<<<<<<< HEAD
        ...
        const getAd = fetch(`${config.serverApi}/getAd`)
            ...
            .catch(error => console.error('Error:', error));
=======
        Promise.all([getWebsite]).then(
            result => {
                // console.log(result);
                const [website] = result;
                this.setState({ website });
                // console.log(this.state.website.logo_mobile);
            },
            error => {
                console.log(error);
            }
    ...
    render() {
        // console.log(this.state.website.logo_mobile);
        console.log(this.state.website ? this.state.website.logo_mobile : null);
        return (
            <Router>
                <div className="Home">
                    <div className="Header">
                        <Link to="/">
                            {/* <img src={this.state.website.logo_mobile} alt="logo" /> */}
                        </Link>
>>>>>>> 7fb131b8acf525f838ff16a0595130fc36f2bcf2
